...
all_metrics = {
  "k-nn": {
    "description": "Recall",
    "function": lambda true_distances, run_distances, run_attrs: knn(
      true_distances, run_distances, run_attrs["count"]
    ),
    "worst": float("-inf"),
    "lim": [0.0, 1.03],
  },
  "epsilon": {
    ...
    "function": lambda true_distances, run_distances, run_attrs: epsilon(
      true_distances, run_distances, run_attrs["count"]
    ),
    "worst": float("-inf"),
  },
  "largeepsilon": {
    ...
    "function": lambda true_distances, run_distances, run_attrs: epsilon(
      true_distances, run_distances, run_attrs["count"], 0.1
    ),
    "worst": float("-inf"),
  },
  "rel": {
  ...
  "qps": {
    ...
    "function": lambda true_distances, run_distances, run_attrs: queries_per_second(
  ...
  "build": {
    ...
    "function": lambda true_distances, run_distances, run_attrs: build_time(
      true_distances, run_attrs
    ),
    "worst": float("inf"),
  },
  "candidates": {
    ...
    "function": lambda true_distances, run_distances, run_attrs: candidates(
      true_distances, run_attrs
    ),
    "worst": float("inf"),
  },
  "indexsize": {
    ...
    "function": lambda true_distances, run_distances, run_attrs: index_size(
      true_distances, run_attrs
    ),
    "worst": float("inf"),
  },
  "queriessize": {
    ...
    / queries_per_second(true_distances, run_attrs),
    "worst": float("inf"),
  },
}
