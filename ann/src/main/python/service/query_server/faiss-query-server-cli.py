...
AURORA_FILE_PATH = "ann/src/main/aurora/service/query_server/faiss/query_server.aurora"
DEFAULT_METASPACE_MB = 512
DEFAULT_PACKER_ROLE = "ann-platform"
DEFAULT_PACKER_NAME = "faiss-query-server"
...
if __name__ == "__main__":
  ...
  parser.add_argument(
    "--hadoop_cluster",
    type=str,
    choices=["dw2-smf1", "proc-atla", "proc2-atla", "proc3-atla"],
    help="HDFS cluster",
    default="dw2-smf1",
  )
  parser.add_argument(
