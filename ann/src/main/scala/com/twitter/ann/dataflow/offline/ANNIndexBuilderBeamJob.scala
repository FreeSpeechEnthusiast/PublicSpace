...
trait ANNOptions extends DateRangeOptions {
  ...
  @Description(
    "Use the old hacky DAL registration instead of the official solution. This flag is to " +
      "support existing use cases and should not be used for new use cases.")
  @Default.Boolean(false)
  @Deprecated
  def getUseOldDALRegistration: Boolean
  def setUseOldDALRegistration(value: Boolean): Unit
